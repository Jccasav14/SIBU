...
import { getAppointments } from '../../services/reportsApi'
...
async function load() {
  ...
  loading.value = true
  try {
    rows.value = await getAppointments({ from: from.value, to: to.value })
  } catch (e) {
